...
extern PROTOBUF_INTERNAL_EXPORT_DirectoryModel_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_AgentService_DirectoryModel_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_DirectoryModel_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_WhitePageEntry_DirectoryModel_2eproto;
namespace org {
namespace copdai {
namespace core {
namespace model {
...
static void InitDefaultsscc_info_AgentService_DirectoryModel_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_AgentService_DirectoryModel_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_AgentService_DirectoryModel_2eproto}, {}};

static void InitDefaultsscc_info_WhitePageEntry_DirectoryModel_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_WhitePageEntry_DirectoryModel_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_WhitePageEntry_DirectoryModel_2eproto}, {}};

static void InitDefaultsscc_info_WhitePages_DirectoryModel_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_WhitePages_DirectoryModel_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_WhitePages_DirectoryModel_2eproto}, {
      &scc_info_WhitePageEntry_DirectoryModel_2eproto.base,}};

static void InitDefaultsscc_info_YellowPages_DirectoryModel_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_YellowPages_DirectoryModel_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_YellowPages_DirectoryModel_2eproto}, {
      &scc_info_AgentService_DirectoryModel_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_DirectoryModel_2eproto[4];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_DirectoryModel_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_DirectoryModel_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_DirectoryModel_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_DirectoryModel_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "IR\020\003"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_DirectoryModel_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_DirectoryModel_2eproto_sccs[4] = {
  &scc_info_AgentService_DirectoryModel_2eproto.base,
  &scc_info_WhitePageEntry_DirectoryModel_2eproto.base,
  &scc_info_WhitePages_DirectoryModel_2eproto.base,
  &scc_info_YellowPages_DirectoryModel_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_DirectoryModel_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_DirectoryModel_2eproto = {
  false, false, descriptor_table_protodef_DirectoryModel_2eproto, "DirectoryModel.proto", 564,
  &descriptor_table_DirectoryModel_2eproto_once, descriptor_table_DirectoryModel_2eproto_sccs, descriptor_table_DirectoryModel_2eproto_deps, 4, 0,
  schemas, file_default_instances, TableStruct_DirectoryModel_2eproto::offsets,
  file_level_metadata_DirectoryModel_2eproto, 4, file_level_enum_descriptors_DirectoryModel_2eproto, file_level_service_descriptors_DirectoryModel_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_DirectoryModel_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_DirectoryModel_2eproto)), true);
namespace org {
namespace copdai {
namespace core {
namespace model {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ServiceConsumptionPattern_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_DirectoryModel_2eproto);
  return file_level_enum_descriptors_DirectoryModel_2eproto[0];
}
...
void WhitePages::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_WhitePages_DirectoryModel_2eproto.base);
  lastupdate_ = 0;
}
...
void WhitePageEntry::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_WhitePageEntry_DirectoryModel_2eproto.base);
  aid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  time_ = 0;
}
...
void AgentService::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_AgentService_DirectoryModel_2eproto.base);
  aid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  type_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  inputtype_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void YellowPages::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_YellowPages_DirectoryModel_2eproto.base);
  lastupdate_ = 0;
}
