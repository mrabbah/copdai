...
extern PROTOBUF_INTERNAL_EXPORT_BoatActuation_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_BoatModel1Command_BoatActuation_2eproto;
namespace org {
namespace copdai {
namespace core {
namespace model {
...
static void InitDefaultsscc_info_BoatModel1Command_BoatActuation_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_BoatModel1Command_BoatActuation_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_BoatModel1Command_BoatActuation_2eproto}, {}};

static void InitDefaultsscc_info_BoatModel1CommandHistory_BoatActuation_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_BoatModel1CommandHistory_BoatActuation_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_BoatModel1CommandHistory_BoatActuation_2eproto}, {
      &scc_info_BoatModel1Command_BoatActuation_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_BoatActuation_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_BoatActuation_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_BoatActuation_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_BoatActuation_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_BoatActuation_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_BoatActuation_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_BoatActuation_2eproto_sccs[2] = {
  &scc_info_BoatModel1Command_BoatActuation_2eproto.base,
  &scc_info_BoatModel1CommandHistory_BoatActuation_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_BoatActuation_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_BoatActuation_2eproto = {
  false, false, descriptor_table_protodef_BoatActuation_2eproto, "BoatActuation.proto", 258,
  &descriptor_table_BoatActuation_2eproto_once, descriptor_table_BoatActuation_2eproto_sccs, descriptor_table_BoatActuation_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_BoatActuation_2eproto::offsets,
  file_level_metadata_BoatActuation_2eproto, 2, file_level_enum_descriptors_BoatActuation_2eproto, file_level_service_descriptors_BoatActuation_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_BoatActuation_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_BoatActuation_2eproto)), true);
namespace org {
namespace copdai {
namespace core {
namespace model {
...
void BoatModel1CommandHistory::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_BoatModel1CommandHistory_BoatActuation_2eproto.base);
...
const BoatModel1Command& BoatModel1Command::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_BoatModel1Command_BoatActuation_2eproto.base);
  return *internal_default_instance();
}
